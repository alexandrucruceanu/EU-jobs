...
### INC-007: Regional Coordinate Discrepancies (Malta)
**Date:** 2026-03-24  
**Severity:** Low  
**Symptom:** Malta was visually rendered inside Turkey or in incorrect positions on the Map view.  
**Root Cause:** Inaccurate lat/long centroids for very small island nations and bounding box calculation errors in the Albers projection.  
**Resolution:** Manually adjusted the geographic coordinates in the data pipeline to ensure accurate visual placement on the choropleth map.

---

### INC-008: Eurostat Earnings API Returning 0 Records
**Date:** 2026-03-25  
**Severity:** High  
