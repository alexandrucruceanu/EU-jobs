...
| **Dark & Light Mode** | Native theme switcher with adaptive canvas rendering |
| **High-Res PNG Export** | 2x branded visual snapshot export with watermark metadata |
...
| **Localized Quotes** | 15 "sad-funny" job market quotes randomly selected in the footer |
| **4 color layers** | Growth Outlook · Median Pay · Education · AI Exposure |
| **Cookie Consent** | Premium glassmorphism-style banner for tracking transparency |
...
| **Deep-linking URLs** | Full state synchronization in URL query parameters |
